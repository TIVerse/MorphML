...
class TestMultiObjectiveIndividual:
    ...
    def test_dominance_strict(self):
        ...
        ind1 = MultiObjectiveIndividual(
            genome=None,
            objectives={'f1': 0.9, 'f2': 0.8}
        )
        ind2 = MultiObjectiveIndividual(
            genome=None,
            objectives={'f1': 0.5, 'f2': 0.6}
        )
    ...
    def test_dominance_partial(self):
        ...
        ind1 = MultiObjectiveIndividual(
            genome=None,
            objectives={'f1': 0.9, 'f2': 0.5}
        )
        ind2 = MultiObjectiveIndividual(
            genome=None,
            objectives={'f1': 0.5, 'f2': 0.9}
        )
    ...
    def test_dominance_mixed_objectives(self):
        ...
        ind1 = MultiObjectiveIndividual(
            genome=None,
            objectives={'accuracy': 0.9, 'latency': 10.0}
        )
        ind2 = MultiObjectiveIndividual(
            genome=None,
            objectives={'accuracy': 0.8, 'latency': 15.0}
        )
...
class TestNSGA2Optimizer:
    ...
    def test_crowding_distance(self):
        ...
        assert front[0].crowding_distance == float('inf') or \
               front[2].crowding_distance == float('inf')
