...
class TestParticleSwarmOptimizer:
    ...
    def setup_method(self):
        ...
        self.config = {"num_particles": 10, "max_iterations": 5, "w": 0.7, "c1": 1.5, "c2": 1.5}

    def test_initialization(self):
        """Test PSO initialization."""
        optimizer = ParticleSwarmOptimizer(self.search_space, self.config)
    ...
    def test_optimize_simple(self):
        ...
        optimizer = ParticleSwarmOptimizer(
            self.search_space, {"num_particles": 5, "max_iterations": 3}
        )
    ...
    def test_adaptive_inertia(self):
        ...
        optimizer.update_velocity(particle, iteration=0)
        optimizer.update_velocity(particle, iteration=9)
...
def test_convenience_function():
    ...
    best = optimize_with_pso(space, evaluator, num_particles=5, max_iterations=3, verbose=False)
