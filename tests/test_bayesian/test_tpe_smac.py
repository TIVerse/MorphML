...
from morphml.optimizers.bayesian import SMACOptimizer, TPEOptimizer
...
class TestTPEOptimizer:
    ...
    def setup_method(self):
        ...
        self.config = {"n_initial_points": 3, "max_iterations": 10, "gamma": 0.25}

    def test_initialization(self):
        """Test TPE optimizer initialization."""
        optimizer = TPEOptimizer(self.search_space, self.config)
    ...
    def test_optimize_simple(self):
        ...
        optimizer = TPEOptimizer(self.search_space, {"n_initial_points": 3, "max_iterations": 5})
    ...
    def test_get_history(self):
        ...
        optimizer = TPEOptimizer(self.search_space, {"n_initial_points": 2, "max_iterations": 3})
...
class TestSMACOptimizer:
    ...
    def setup_method(self):
        """Setup test fixtures."""
        self.search_space = create_cnn_space(num_classes=10)
        self.config = {"n_initial_points": 3, "max_iterations": 10, "n_estimators": 10}

    def test_initialization(self):
        """Test SMAC optimizer initialization."""
        optimizer = SMACOptimizer(self.search_space, self.config)
    ...
    def test_optimize_simple(self):
        ...
        optimizer = SMACOptimizer(
            self.search_space, {"n_initial_points": 3, "max_iterations": 5, "n_estimators": 5}
        )
    ...
    def test_get_history(self):
        """Test history tracking."""
        optimizer = SMACOptimizer(
            self.search_space, {"n_initial_points": 2, "max_iterations": 3, "n_estimators": 5}
        )
...
def test_tpe_convenience_function():
    ...
    best = optimize_with_tpe(space, evaluator, n_iterations=5, verbose=False)
...
def test_smac_convenience_function():
    ...
    best = optimize_with_smac(space, evaluator, n_iterations=5, verbose=False)
