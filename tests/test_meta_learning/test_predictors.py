...
class TestProxyMetricPredictor:
    ...
    def test_training(self, sample_graphs):
        ...
        training_data = [(graph, 0.7 + np.random.rand() * 0.2) for graph in sample_graphs]
...
class TestLearningCurvePredictor:
    ...
    def test_early_stopping(self):
        ...
        should_stop = predictor.should_early_stop(poor_accuracies, threshold=0.8)
...
class TestEnsemblePredictor:
    ...
    def test_custom_weights(self):
        ...
        ensemble = EnsemblePredictor([predictor1, predictor2], weights=[0.7, 0.3])
