...
class TestArchitectureSimilarity:
    ...
    def test_operation_distribution_similarity(self, sample_graphs):
        ...
        similarity = ArchitectureSimilarity.operation_distribution_similarity(
            graph1, graph2
        )
    ...
    def test_graph_structure_similarity(self, sample_graphs):
        ...
        similarity = ArchitectureSimilarity.graph_structure_similarity(
            graph1, graph2
        )
    ...
    def test_compute_method(self, sample_graphs):
        ...
        sim1 = ArchitectureSimilarity.compute(
            graph1, graph2, method="operation_distribution"
        )
        sim2 = ArchitectureSimilarity.compute(
            graph1, graph2, method="graph_structure"
        )
        sim3 = ArchitectureSimilarity.compute(
            graph1, graph2, method="combined"
        )
