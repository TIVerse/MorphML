...
class LocalTestRunner:
    ...
    def test_phase2_advanced_optimizers(self) -> bool:
        ...
        from morphml.core.dsl import Layer, SearchSpace
        from morphml.optimizers.evolutionary import CMA_ES, DifferentialEvolution
    ...
    def test_phase3_fault_tolerance(self) -> bool:
        ...
        should_retry = ft_manager.handle_task_failure(task, FailureType.NETWORK_ERROR, "timeout")
