...
class TestMemoryUsage:
    ...
    def test_population_memory(self, search_space: SearchSpace):
        ...
        assert size_bytes < 10 * 1024 * 1024, f"Population too large: {size_bytes / 1024 / 1024:.2f} MB"
...
class TestScaling:
    ...
    def test_scaling_with_population_size(
        ...
        assert time_per_individual < 0.1, f"Scaling issue: {time_per_individual:.4f}s per individual"
