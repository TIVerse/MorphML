...
class TestOptimizerComparison:
    ...
    def test_initialization(self):
        ...
        comparison = OptimizerComparison(self.search_space, self.evaluator, budget=10, num_runs=2)
    ...
    def test_add_optimizer(self):
        ...
        optimizer = ParticleSwarmOptimizer(
            self.search_space, {"num_particles": 5, "max_iterations": 2}
        )
    ...
    def test_run_comparison(self):
        ...
        optimizer = ParticleSwarmOptimizer(
            self.search_space, {"num_particles": 3, "max_iterations": 2}
        )
        comparison.add_optimizer("PSO", optimizer)
    ...
    def test_statistics_computation(self):
        ...
        comparison = OptimizerComparison(self.search_space, self.evaluator, budget=10, num_runs=3)
...
def test_compare_optimizers_function():
    ...
    optimizer1 = ParticleSwarmOptimizer(space, {"num_particles": 3, "max_iterations": 2})
