...
class TestDatabaseManager:
    ...
    @pytest.mark.skipif(not os.getenv("MORPHML_TEST_DB"), reason="Database not configured")
    ...
    def test_save_and_retrieve_architecture(self, db_connection_string):
        ...
        # Create experiment
        exp_id = db.create_experiment(name=f"test_arch_{os.getpid()}", config={})
...
class TestDistributedCache:
    ...
    @pytest.mark.skipif(not os.getenv("MORPHML_TEST_REDIS"), reason="Redis not configured")
    ...
    def test_cache_architecture_result(self, redis_url):
        ...
        # Cache result
        cache.cache_architecture_result("abc123", {"fitness": 0.95, "accuracy": 0.95}, ttl=60)
...
class TestArtifactStore:
    ...
    @pytest.mark.skipif(not os.getenv("MORPHML_TEST_BUCKET"), reason="S3 not configured")
