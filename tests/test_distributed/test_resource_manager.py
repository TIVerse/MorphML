...
class TestWorkerResources:
    ...
    def test_gpu_utilization(self) -> None:
        ...
        resources = WorkerResources(
            worker_id="w1", total_gpus=4, available_gpus=3
        )
...
class TestResourceManager:
    ...
    def test_get_total_resources(self) -> None:
        ...
        manager.register_worker(
            "w1", {"total_gpus": 2, "available_gpus": 1, "gpu_memory_total": 8.0, "gpu_memory_available": 4.0}
        )
        manager.register_worker(
            "w2", {"total_gpus": 4, "available_gpus": 3, "gpu_memory_total": 16.0, "gpu_memory_available": 12.0}
        )
    ...
    def test_get_statistics(self) -> None:
        ...
        manager.register_worker(
            "w1", {"total_gpus": 4, "available_gpus": 4}
        )
