...
def plot_pareto_front_3d(
    ...
    ax.scatter(obj1_values, obj2_values, obj3_values, 
...
def plot_parallel_coordinates(
    ...
    """
    try:
        from morphml.optimizers.multi_objective.visualization import plot_parallel_coordinates as pc_plot
...
try:
    from morphml.optimizers.multi_objective.visualization import (
        plot_pareto_front as plot_pareto_front_advanced,
        plot_pareto_3d as plot_pareto_3d_advanced,
    )
except ImportError:
    pass
