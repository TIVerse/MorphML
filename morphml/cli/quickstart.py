...
@click.option('--template', '-t', 
              ...
              help='Template type')
@click.option('--name', '-n', default='my_nas',
              help='Project name')
@click.option('--output', '-o', default=None,
              help='Output file path')
@click.option('--num-classes', default=10,
              help='Number of output classes')
@click.option('--max-params', default=1000000,
              help='Maximum parameters constraint')
@click.option('--population-size', default=20,
              help='Population size')
@click.option('--num-generations', default=50,
